...
<body>
                ...
                <header>
                    <nav>
                        ...
                        <div id="nav-right">
                            ...
                            ?>
                                <a href="index.php?ctrl=forum&action=profil"><span class="fas fa-user"></span>&nbsp;<?= App\Session::getUser() ?></a>
    ...
    <script>
        ...
        // Réécoutez les redimensionnements de fenêtre pour ajuster la classe en conséquence
